...
@Component({
  selector: 'app-view-responder',
  templateUrl: './view-responder.component.html',
  styleUrls: ['./view-responder.component.css']
})
export class ViewResponderComponent implements OnInit {
