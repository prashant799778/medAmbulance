...
def myrides():
    try:
        ...
        if msg == "1":
            ...
            whereCondition3=" and am.ambulanceModeId=aM.Id and am.ambulanceTypeId=atm.id and  bm.userId=um.userId and bm.driverId=dm.driverId and um.userId='"+str(userId)+"' "+whereCondition2
