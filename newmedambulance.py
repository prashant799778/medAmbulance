...
def getNearAmbulancetest():
    try:
        ...
        if msg == "1":
            ...
            whereCondition= " a.driverTypeId='"+str(driverTypeId)+"'" + " and d.status=1 and b.onTrip=0 and b.onDuty=1 and a.driverId=d.driverId  and b.ambulanceId=a.ambulanceId HAVING distance < 25 "
            orderby="  distance "
