...
def support():
    try:
        ...
        if msg == "1":
            ...
            column="bm.id,bm.userMobile,bm.drivermobile,bm.userId,bm.driverId,bm.bookingId,cq.questions,atm.ambulanceType as ambulanceTypeId ,aM.ambulanceType as ambulanceTypeId,bm.pickup as tripFrom,bm.dropOff as tripTo,date_format(bm.ateCreate,'%Y-%m-%d %H:%i:%s')startTime,dm.name as driverName,um.name as userName,bm.status,bm.finalAmount,bm.totalDistance,bm.canceledUserId"
