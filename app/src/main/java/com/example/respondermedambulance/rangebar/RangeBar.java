...
package com.example.respondermedambulance.rangebar;
/*
...
public class RangeBar extends View {
    ...
    private static final int DEFAULT_PIN_COLOR = 0xff1e88e5;

    private static final float DEFAULT_CONNECTING_LINE_WEIGHT_PX = 4;

    // Corresponds to material indigo 500.
    private static final int DEFAULT_CONNECTING_LINE_COLOR = 0xff1e88e5;
