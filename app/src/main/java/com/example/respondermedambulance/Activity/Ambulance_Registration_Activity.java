...
import com.example.respondermedambulance.Widget.Custom_Spinner_For_TextValue;
...
public class Ambulance_Registration_Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        save.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if(!ambulance_model.getText().toString().isEmpty()
    ...
    private void showPopup()
    {
        ...
        ok.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                alertDialog.dismiss();
                startActivity(new Intent(Ambulance_Registration_Activity.this,ResponderMapsActivity.class));
                finish();
            }
        });
    }
