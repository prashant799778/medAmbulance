...
import com.example.respondermedambulance.Activity.ui.home.HomeFragment;
import com.example.respondermedambulance.Activity.ui.home.ResponderHomeFragment;
...
import com.example.respondermedambulance.Fragments.DriverProfile_Fragment;
import com.example.respondermedambulance.Fragments.MyTrip_fragment;
import com.example.respondermedambulance.Fragments.Notifucation_fragment;
import com.example.respondermedambulance.Fragments.ResponderProfile_Fragment;
import com.example.respondermedambulance.Fragments.ResponderTrip_fragment;
import com.example.respondermedambulance.Fragments.Responder_Notifucation_fragment;
...
import com.example.respondermedambulance.util.DirectionsJSONParser;
...
public class ResponderMapsActivity extends FragmentActivity implements OnMapReadyCallback, GoogleApiClient.ConnectionCallbacks,GoogleApiClient.OnConnectionFailedListener
        , LocationListener {

    ListView listView;
    DrawerLayout drawerLayout;
    Atami_Regular number;
    Atami_Bold name;
    ...
    int index=0;
    int next=0;
    ResponderProfile_Fragment profile_fragment;
...
////////////////////bottomsheet///////////////
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_responder_maps);
        Animatoo.animateSlideLeft(ResponderMapsActivity.this);
//bottomsheet
...
///////////////////////////////////////////////////////////////////////////////DrawerLayout/////////////////////////////////////////////////////////
        ...
        responderHomeFragment=new ResponderHomeFragment();
        header=findViewById(R.id.farg_name);
        profile=findViewById(R.id.profile);
        profile_fragment=new ResponderProfile_Fragment();
        Utility.setRoundedImage(ResponderMapsActivity.this,profile,sharedPreferences.getUserProfile());
        ...
        drawerItem[0] = new DrawerModel(R.drawable.texi_image, "Home");
        drawerItem[1] = new DrawerModel(R.drawable.ic_profile, "My Profile");
        drawerItem[2] = new DrawerModel(R.drawable.rate_card,"My Trips");
        drawerItem[3] = new DrawerModel(R.drawable.noti_2, "Notifications");
        ...
        listView.setOnItemClickListener(new DrawerItemClickListner2());
        ...
        sharedPreferences.setUserTypeId("4");
        notifications.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(ResponderMapsActivity.this,AllRequestActivity.class));
        ...
        mapFragment = (SupportMapFragment) getSupportFragmentManager()
                .findFragmentById(R.id.driver_map_main);
    ...
    private class DrawerItemClickListner2 implements AdapterView.OnItemClickListener {
        @Override
    ...
    private void selectItem(int position) {
        ...
        {   case 0:
            ...
            case 4:
               // startActivity(new Intent(DriversMapsActivity.this, SupportActivity.class));
                ...
                break;
            case 5:
                dialog = new Dialog(ResponderMapsActivity.this);
                ...
                yes.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        dialog.dismiss();
                        startActivity(new Intent(ResponderMapsActivity.this,Login.class));
                        finish();
                    }
                });
        ...
        if (fragment != null) {
            FragmentManager fragmentManager = getSupportFragmentManager();
            fragmentManager.beginTransaction().replace(R.id.driver_map_main, fragment).commit();
...
//                    // Because Clean Session is true, we need to re-subscribe
                ...
                public void messageArrived(String topic, MqttMessage message) throws Exception {
                    ...
                    if(topic.equalsIgnoreCase(reqestTopic)){
                        ...
                        ResponderMapsActivity.this.runOnUiThread(new Runnable() {
                            @Override
                            public void run() {
...
//            Toast.makeText(getApplicationContext(),e.toString(),Toast.LENGTH_LONG).show();
                ...
                switch (status.getStatusCode()) {
                    ...
                    case LocationSettingsStatusCodes.RESOLUTION_REQUIRED:
                        ...
                        try {
                            ...
                            // in onActivityResult().
                            status.startResolutionForResult(ResponderMapsActivity.this, REQUEST_CHECK_SETTINGS);
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        profile_fragment.setImage(requestCode,resultCode,data);
