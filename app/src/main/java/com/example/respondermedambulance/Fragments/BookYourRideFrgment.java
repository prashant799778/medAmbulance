...
import com.example.respondermedambulance.Activity.Countinue_As_Acrtivity;
import com.example.respondermedambulance.Activity.DestinationActivity;
import com.example.respondermedambulance.Activity.DriversMapsActivity;
...
import com.example.respondermedambulance.Adapters.Horizontal_adapter;
...
import com.example.respondermedambulance.Model.Ambulance;
...
import com.example.respondermedambulance.util.PlaceJSONParserTemp;
...
import static com.example.respondermedambulance.Fragments.UserBookYourRideFragment.MY_PERMISSIONS_REQUEST_LOCATION;
...
public class BookYourRideFrgment extends Fragment implements OnMapReadyCallback,
    ...
    Marker nearby_cab;
    LinearLayout for_ambulance,for_responder,location_field_layout,selection_layout,for_noraml,for_govt,bottomlayout,ALS,BLS,DBT,PVT,AIR;
...
//
            ...
            if(response_data.getString("status").equalsIgnoreCase("true")){
                ...
                for( int i=0;i<jsonArray.length();i++){
                    ...
                    bitmapDrawable = (BitmapDrawable) getResources().getDrawable(R.drawable.amb);}else {
...
//                    // Because Clean Session is true, we need to re-subscribe
                ...
                public void messageArrived(String topic, MqttMessage message) throws Exception {
                    ...
                    Utility.log("Arrievd MQTTT",""+message.toString()+"With Topic"+topic);
...
//                btnBookNow_layout.setVisibility(View.GONE);
                ...
                bitmapDrawable = (BitmapDrawable) getResources().getDrawable(R.drawable.amb);}else { bitmapDrawable = (BitmapDrawable) getResources().getDrawable(R.drawable.responder);
                }
                Bitmap b = bitmapDrawable.getBitmap();
                Bitmap smallCar = Bitmap.createScaledBitmap(b, 60, 72, false);
    ...
    public void bookingConfiramationPopup(final String bookingId)
    {
        getActivity().runOnUiThread(new Runnable() {
            ...
            public void run() {
                ...
                dialog.getWindow().addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP |Intent.FLAG_ACTIVITY_NEW_TASK );
                dialog.setCanceledOnTouchOutside(false);Atami_Regular bookingid=dialog.findViewById(R.id.bokingid);
    ...
    public void driverArrivedPopup(final String data)
    {
        ...
        getActivity().runOnUiThread(new Runnable() {
            ...
            public void run() {
                ...
                if(userTypeId.equalsIgnoreCase("1"))
                {
                msg.setText("Driver Arrived");}else {msg.setText("Responder Arrived");}
                dialog.getWindow().addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP |Intent.FLAG_ACTIVITY_NEW_TASK );
                dialog.setCanceledOnTouchOutside(false);
                int Width =(int) (getResources().getDisplayMetrics().widthPixels*1);
