package com.example.respondermedambulance.Widget;
...
public class Custom_Spinner extends AppCompatTextView implements View.OnClickListener {
...
//        this.setText(string);
    ...
    public void setOptions(ArrayList<String> options,Custom_Spinner textView) {
