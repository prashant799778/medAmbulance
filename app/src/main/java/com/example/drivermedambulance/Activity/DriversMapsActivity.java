...
import com.example.drivermedambulance.Fragment.BottomSheetFragment;
...
import com.example.drivermedambulance.Fragments.Myprofile_Fragment;
...
import com.example.drivermedambulance.cognalys.GPSTracker;
...
public class DriversMapsActivity extends FragmentActivity implements OnMapReadyCallback, GoogleApiClient.ConnectionCallbacks,GoogleApiClient.OnConnectionFailedListener
    ...
    DriverProfile_Fragment profile_fragment;
...
///////////////////////////////////////////////////////////////////////////////DrawerLayout/////////////////////////////////////////////////////////
        ...
        profile_fragment=new DriverProfile_Fragment();
        Utility.setRoundedImage(DriversMapsActivity.this,profile,sharedPreferences.getUserProfile());
    ...
    private class DrawerItemClickListner2 implements android.widget.AdapterView.OnItemClickListener {
        @Override
            ...
            case 5:
                ...
                yes.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        dialog.dismiss();
                        startActivity(new Intent(DriversMapsActivity.this,Login.class));
                        finish();
                    }
                });
