...
public class MyNewUserActivity extends FragmentActivity implements OnMapReadyCallback, GoogleApiClient.ConnectionCallbacks,GoogleApiClient.OnConnectionFailedListener
        , LocationListener {
...
///////////////////////////////////////////////////////////////////////////////DrawerLayout/////////////////////////////////////////////////////////
        ...
        notifications.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(MyNewUserActivity.this,AllRequestActivity.class));
...
//                    // Because Clean Session is true, we need to re-subscribe
                ...
                public void messageArrived(String topic, MqttMessage message) throws Exception {
                    ...
                    if(topic.equalsIgnoreCase(reqestTopic)){
                        ...
                        MyNewUserActivity.this.runOnUiThread(new Runnable() {
                            @Override
                            public void run() {
                ...
                switch (status.getStatusCode()) {
                    ...
                    case LocationSettingsStatusCodes.RESOLUTION_REQUIRED:
                        ...
                        try {
                            ...
                            // in onActivityResult().
                            status.startResolutionForResult(MyNewUserActivity.this, REQUEST_CHECK_SETTINGS);
