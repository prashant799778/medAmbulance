...
import com.example.drivermedambulance.Activity.Current_Location_Activity;
                ...
                switch (v.getId())
                {
                    case  R.id.signup:
...

                        {
                            ...
                            progressDialog.show();
                            Api_Calling.postMethodCall(getContext(), URLS.driverSignup,v,myResult,"SingUp",signUpJos());
                            break;
                        }else {
