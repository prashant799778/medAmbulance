...
//
        ...
        //    String pickup_location_cabs_request = "user_lat=" + URLEncoder.encode(String.valueOf(user_lat), "UTF-8") + "&user_lng=" + URLEncoder.encode(String.valueOf(user_lng), "UTF-8");
          ...
          markers.add(nearby_cab1);
                ...
                AppUtil.topSnakBar(getApplicationContext(),getWindow().getDecorView().getRootView(),response_data.getString("message"));
            }
...
//                Toast.makeText(getApplication(), e.getMessage(), Toast.LENGTH_SHORT).show();
    ...
    private  void  setupUi(){
        ...
        RecyclerView recyclerView = (RecyclerView)findViewById(R.id.rc_h);
      ...
      arrayList.add("");
       arrayList.add("ewr");
        Horizontal_adapter horizontal_adapter=new Horizontal_adapter(getApplicationContext(),arrayList);
